      ...
      >
        {all.loading ? (
          ...
          <>
            {/* En vivo destacado */}
            {live ? (
              <Pressable onPress={() => navigation.navigate('Live', { id: String(live.id) })} style={{ marginHorizontal: 16, marginBottom: 14, marginTop: 14 }}>
                <LinearGradient
            ...
            {ctaMatch ? (
              <View style={{ paddingHorizontal: 16, paddingBottom: 16, paddingTop: live ? 0 : 14 }}>
                <Card onPress={() => navigation.navigate('Simular', { id: String(ctaMatch.id) })} style={{ overflow: 'hidden' }}>
                  <View
                    style={{
                      position: 'absolute',
                      right: -30,
