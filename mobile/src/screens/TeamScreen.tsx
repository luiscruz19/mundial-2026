...
export default function ScreenTeam({ route }: Props) {
  const { t } = useTokens();
      ...
      hero={
        ...
        >
          ...
          <View style={{ flexDirection: 'row', gap: 10, marginTop: 16 }}>
            ...
            {nextMatch ? (
              <Pressable
                onPress={() => navigation.navigate('Simular', { id: String(nextMatch.id) })}
                style={{
                  borderRadius: radii.pill,
                  paddingVertical: 11,
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>
          <Card pad={14} style={{ flex: 1 }}>
            ...
            {nextMatch && nextOpponent ? (
              <Pressable onPress={() => navigation.navigate('Match', { id: String(nextMatch.id) })} style={{ flexDirection: 'row', alignItems: 'center', gap: 9, marginTop: 9 }}>
