// AUTOGENERADO desde el Anexo C oficial de FIFA ("Regulations for the FIFA World Cup 26").
// NO editar a mano. Asignación oficial de los 8 mejores terceros a los cruces de 16avos (R32).
//
// Clave: combinación ordenada (A–L) de los 8 grupos cuyo 3° clasifica, p.ej. "BDEFIJKL".
// Valor: { "1X": "Y" } = el ganador del grupo X enfrenta al 3° del grupo Y.
// Fuente verificada: https://github.com/dw-football/wc2026-bracket (allocation.json) ↔ Annexe C.
//
// Los 8 ganadores que enfrentan a un tercero son los de los grupos A, B, D, E, G, I, K, L.
export const THIRD_PLACE_ALLOCATION: Record<string, Record<string, string>> = {
